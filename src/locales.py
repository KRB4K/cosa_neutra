...
TRANSLATIONS = {
    'en': {
        ...
        Token.TUTO_ROLES: "To enhance the quality of submissions, there are two roles in the game: Neutralizer and Reviewer., while Reviewers are responsible for reviewing the neutralizations.",
        Token.TUTO_NEUTRALIZER: "Neutralizers are responsible for neutralizing the text. If you are neutraliser, your goal is to provide the best gender-agnostic alternative translation. Just type it in the chat and send it. If the segment did not require any modification, copy paste the original segment in the chat and send it.",
        Token.TUTO_REVIEWER: "Reviewers are responsible for reviewing the neutralizations. If you are a reviewer, your goal is to pick the best neutralizations from the list you will be given. Just copy paste the one you think is best in the chat and send it.",
        Token.TUTO_HYBRID: "On top of neutralizers and reviewers, a player can also be hybrid. This means that they play both roles at the same time: they will be assigned a neutralization or a review at random. However, they will not be able to review their own neutralizations.",
        Token.TUTO_LEADERBOARD: "The leaderboard shows the player's scores. Neutralizing and reviewing always grants points. If you're a neutralizer, bonus points are granted if your neutralization was picked the most by reviewers. If you're a reviewer, bonus points are granted if your review was the one most picked by other reviewers.",
        ...
        Token.TUTO_END: "That's it! You are now ready to play. If that's your first time here, we'll ask a couple of question to get you started.",
    ...
    'fr': {
        ...
        Token.TUTO_GAME_GOAL: "Le but du jeu est de rendre les traductions de jeux vidéo neutres en termes de genre. Cela signifie que les références au personnage du joueur ne doivent pas avoir de marqueur de genre. C'est ce que nous appelons la 'Neutralisation'.",
        Token.TUTO_ROLES: "Pour améliorer la qualité des soumissions, il y a deux rôles dans le jeu : Neutraliseur et Réviseur. Les Neutraliseurs sont responsables de la neutralisation du texte, tandis que les Réviseurs sont responsables de la révision des neutralisations.",
        Token.TUTO_NEUTRALIZER: "Les Neutraliseurs sont responsables de la neutralisation du texte. Si vous êtes un neutraliseur, votre objectif est de fournir la meilleure alternative de traduction neutre en termes de genre. Il vous suffit de la taper dans le chat et de l'envoyer. Si le segment ne nécessitait aucune modification, copiez-collez le segment original dans le chat et envoyez-le.",
        Token.TUTO_REVIEWER: "Les Réviseurs sont responsables de la révision des neutralisations. Si vous êtes un réviseur, votre objectif est de choisir les meilleures neutralisations de la liste qui vous sera donnée. Il vous suffit de copier-coller celle que vous pensez être la meilleure dans le chat et de l'envoyer.",
        Token.TUTO_HYBRID: "En plus des neutraliseurs et des réviseurs, un joueur peut également être hybride. Cela signifie qu'il joue les deux rôles en même temps : il se verra attribuer une neutralisation ou une révision au hasard. Cependant, il ne pourra pas réviser ses propres neutralisations.",
        Token.TUTO_LEADERBOARD: "Le classement montre les scores des joueurs. La neutralisation et la révision accordent toujours des points. Si vous êtes un neutraliseur, des points bonus sont accordés si votre neutralisation a été choisie le plus souvent par les réviseurs. Si vous êtes un réviseur, des points bonus sont accordés si votre révision a été la plus choisie par les autres réviseurs.",
        ...
        Token.TUTO_TEAM: "Les joueurs peuvent faire partie d'une équipe (ou choisir de jouer en solo). Il y a un classement pour les joueurs en solo et un pour les équipes. De plus, les joueurs ne peuvent réviser que les neutralisations qui ne sont PAS de leurs coéquipiers.",
