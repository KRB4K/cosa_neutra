...
TRANSLATIONS = {
    'en': {
        ...
        Token.MAIN_MENU_REPORT: "/report to report an inappropriate segment (hate speech, trolling, etc.) during the game",
    ...
    'fr': {
        ...
        Token.MAIN_MENU_REPORT: "/report pour signaler un segment inapproprié (discours de haine, troll, etc.) lors de la partie",
